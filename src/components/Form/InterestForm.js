  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (response.data.success === true) {
        toast.update(id, {
          render:
            "Thank you for showing interest, kindly check your email for more info.",
          type: "success",
          isLoading: false,
          position: "top-center",
          autoClose: true,
      ...
      <div class="flex bg-white items-center justify-center mt-28 mb-32">
        <div class="grid bg-white rounded-lg w-11/12 md:w-11/12 lg:w-9/12">
          <div class="flex justify-center">
            <div class="flex">
              <h2 className="interest-header font-semibold text-2xl font-Gilroy sm:text-3xl text-center sm:mb-5 mb-5">
                Solidify your interest by filling the form below
              </h2>
            </div>
          </div>
          <form onSubmit={handleSubmit}>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-20 mt-5 sm:mt-16 mx-2">
              ...
              <div class="grid grid-cols-1">
                <label
                  className="sm:text-2xl text-md font-Gilroy font-semibold text-gray-500"
                  htmlFor="deployed_state"
                >
                  State of deployment
                </label>
                <div className="relative">
                  <select
                    className="block font-Gilroy appearance-none w-full border pr-8 leading-normal input-field my-1 rounded bg-transparent py-3 px-3 text-md focus:outline-none focus:border-transparent"
                    id="deployed_state"
                    name="deployed_state"
                    onChange={handleChange}
            ...
            <div className="text-center mt-5 sm:mt-10">
              <button
                className="bg-black font-Gilroy w-auto text-white px-5 sm:px-9 sm:py-4 py-3 rounded-md font-semibold border-none active:bg-gray-600 "
                type="submit"
              >
                Submit my details
              </button>
