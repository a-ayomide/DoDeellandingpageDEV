        ...
        <div className="container bg-white mx-auto">
          <div className="flex justify-between items-center py-6 md:justify-start md:space-x-10 ">
            ...
            <nav className="hidden md:flex space-x-18">
              ...
              <div id="nav-text">
                <Link
                  className="mx-5 border-transparent border-b-2 hover:border-green-600 hover:text-green-600 font-Gilroy font-normal"
                  to="/about"
                >
                  About
                </Link>
            ...
            <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
              <button id="button-outline" className="rounded-md py-2 px-4">
                <AnchorLink href="#InterestForm">
                  <p className="button-text font-Gilroy font-semibold md:text-lg">
                    I'm interested!
                  </p>
                </AnchorLink>
              </button>
